...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  page: { flex: 1, paddingHorizontal: spacing.md, paddingTop: 28, paddingBottom: 94 }, today: { color: colors.muted, fontSize: 16, fontWeight: '600', textAlign: 'center' }, balance: { alignItems: 'center', paddingTop: 28, paddingBottom: 50 }, balanceLine: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'center', gap: 10 }, balanceNumber: { fontSize: 80, lineHeight: 84, fontWeight: '700', letterSpacing: -4 }, balanceWord: { fontSize: 28, lineHeight: 37, fontWeight: '600', letterSpacing: -1 }, targetText: { marginTop: 12, color: colors.muted, fontSize: 15, textAlign: 'center' }, listHeader: { height: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, addIconButton: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.ink, shadowColor: '#000', shadowOpacity: 0.13, shadowOffset: { width: 0, height: 3 }, shadowRadius: 6, elevation: 3 }, iconPressed: { opacity: 0.62 }, plusFallback: { color: colors.surface, fontSize: 25, lineHeight: 27 },
