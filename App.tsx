...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  page: { flex: 1, paddingHorizontal: spacing.md, paddingTop: 28, paddingBottom: 94 }, today: { color: colors.muted, fontSize: 16, fontWeight: '600', textAlign: 'center' }, balance: { alignItems: 'center', paddingTop: 20, paddingBottom: 34 }, balanceRing: { width: RING_SIZE, height: RING_SIZE, alignItems: 'center', justifyContent: 'center' }, ringCanvas: { position: 'absolute' }, balanceContent: { alignItems: 'center', justifyContent: 'center' }, balanceLine: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'center', gap: 8 }, balanceNumber: { fontSize: 72, lineHeight: 78, fontWeight: '700', letterSpacing: -3.5 }, balanceWord: { fontSize: 27, lineHeight: 36, fontWeight: '600', letterSpacing: -1 }, targetText: { marginTop: 10, color: colors.muted, fontSize: 15, textAlign: 'center' }, listHeader: { height: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, addIconButton: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.ink, shadowColor: '#000', shadowOpacity: 0.13, shadowOffset: { width: 0, height: 3 }, shadowRadius: 6, elevation: 3 }, iconPressed: { opacity: 0.62 }, plusFallback: { color: colors.surface, fontSize: 25, lineHeight: 27 },
